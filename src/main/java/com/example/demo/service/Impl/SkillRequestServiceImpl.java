...
//     @Override
//     public SkillRequest updateRequest(Long id, SkillRequest request) throws Exception {
...
//     @Override
//     public SkillRequest getRequestById(Long id) throws Exception {
...
//     @Override
//     public void deactivateRequest(Long id) throws Exception {
//         SkillRequest existing = getRequestById(id);
...
public class SkillRequestServiceImpl implements SkillRequestService {
    ...
    public SkillRequest getRequestById(Long id) {
        return repo.findById(id).orElseThrow(() -> new ResourceNotFoundException("Request not found"));
    }
//     public SkillRequest getRequestById(Long id) {
//     return repo.findById(id)
